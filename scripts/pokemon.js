const pokemon = (function() {
  function setPokemonResult(code) {
    var setcards = "";
    var setmodal = "";
    var url = "https://api.pokemontcg.io/v1/cards?setCode=" + code;
    fetch(url)
      .then(result => result.json())
      .then(allDetails => {
        allDetails.cards.map(r => {
              ...
              <div class="modal-content">
                ...
                <div class="main-modal">
                  ...
                  <div class="poke-details">
                    <p class="poke-title">${
                      r.name
                    } Pokémon - <span class="gray">${r.subtype}</span></p>
                    <hr />
                    ${r.attacks
                      .map(
                        poke =>
  ...
  function subtypePokemonResult(code) {
    var setcards = "";
    var setmodal = "";
    var url = "https://api.pokemontcg.io/v1/cards?subtype=" + code;
    fetch(url)
      .then(result => result.json())
      .then(allDetails => {
        allDetails.cards.map(r => {
          ...
          <div class="modal-content">
            <div class="modal-header">
              <p class="modal-title">Card Details</p>
              <span class="close" onclick="document.getElementById('${r.id}').style.display='none'">&times;</span>
            </div>
            <div class="main-modal">
              <div class="poke-avatar">
                <img
              ...
              <div class="poke-details">
                <p class="poke-title">${r.name} Pokémon - <span class="gray">${r.subtype}</span></p>
                <hr />
                <div class="stats">
                  <div class="stats-details">
                    <p>WEAKNESS</p>
